...
$(document).on("pageinit", function() {
    ...
    var setprescriptiontext = function() {
        ...
        $("input[name=cb-scheme]:checked").each(function() {
            var_schemechecked.push(parseInt($(this).val()));
        });
        ...
        var var_phrase = var_ftxtnumbers[var_intakechecked] + " " + var_intake + " " + var_meal[var_mealchecked]+var_everyselect[var_everytypechecked]+" "+var_everytxtnumbers[var_everychecked]+" "+var_durationplural[var_everytypechecked]+" "+"pendant"+" "+var_mtxtnumbers[var_durationchecked]+" "+var_duration[var_durationtypechecked];
